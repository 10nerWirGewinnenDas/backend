...
export class GetBlackSpotDto extends IntersectionType(PrismaModel.BlackSpot, PrismaModel.Category, PickType(PrismaModel.BlackSpotRelations, ["comments", "votes"])) {
    @ApiProperty({
